...
const AdminProducts = () => {
  ...
  const [subCategoriesMap, setSubCategoriesMap] = useState({}); // 🔥 subcategories üçün map
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const subCategoriesSnap = await get(ref(db, "subCategories")); // 🔥 BURDA subcategories əlavə çəkirik
        ...
        const subCategoriesData = subCategoriesSnap.exists() ? subCategoriesSnap.val() : {}; // 🔥 map formatında

        setProducts(productsData);
        setFilteredProducts(productsData);
        setCategories(categoriesData);
        setSubCategoriesMap(subCategoriesData); // 🔥 bunu saxlayırıq
