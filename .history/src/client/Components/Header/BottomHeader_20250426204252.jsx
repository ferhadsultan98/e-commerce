// src/client/Components/BottomHeader/BottomHeader.jsx
...
const BottomHeader = ({
  ...
  wishlistItems,
  cartItems,
  compareItems, // Added compareItems prop
}) => {
  const [wishlistCount, setWishlistCount] = useState(0);
  const [cartCount, setCartCount] = useState(0);
  const [compareCount, setCompareCount] = useState(0); // Added compareCount
  ...
  useEffect(() => {
    ...
    setCompareCount(compareItems.length); // Update compare count
  }, [wishlistItems, cartItems, compareItems]);
        ...
        <div className="bottomContainer">
          <div className="bottomHeaderWrapper">
            ...
            <div className="headerActions">
              ...
              <Link to="/compare" className="actionButton compareButton">
                <GoGitCompare size={20} />
                {compareCount > 0 && (
                  <span className="badge">{compareCount}</span>
                )}
                <span className="actionText">Compare</span>
              </Link>
            </div>
          </div>
        </div>
