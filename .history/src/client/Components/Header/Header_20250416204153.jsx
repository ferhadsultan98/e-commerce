...
import { Search, Heart, ShoppingCart, ChevronDown, Phone, MapPin, Tag, Globe } from 'lucide-react';
import '../../';
...
const Header = () => {
  ...
  const categories = [
    'Laptops', 'Smartphones', 'Tablets', 'Audio', 'Cameras', 
    'TVs', 'Gaming', 'Wearables', 'Smart Home', 'Accessories'
  ];
  
  const trendingProducts = [
    'iPhone 14 Pro', 'Samsung Galaxy S23', 'MacBook Air M2', 'Sony WH-1000XM5'
  ];
