        ...
        <div className="bottomContainer">
          <div className="bottomHeaderWrapper">
            ...
            <div className="headerActions">
              <Link to="/wishlist" className="bthActionButton wishlistButton">
                <Heart size={20} />
                {wishlistCount > 0 && (
              ...
              <Link to="/shoppingcard" className="bthActionButton bthCartButton">
                <ShoppingCart size={20} />
                {cartCount > 0 && <span className="badge">{cartCount}</span>}
                <span className="actionText">Cart</span>
              </Link>

              <Link to="/compare" className="bthActionButton bthCompareButton">
