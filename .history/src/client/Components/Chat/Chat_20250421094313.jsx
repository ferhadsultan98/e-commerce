...
const ChatWidget = () => {
  ...
  const handleBotResponse = (userMessage) => {
    ...
    if (userMessage.toLowerCase().includes('product')) {
      botResponse = "We offer a wide range of technology products including smart devices, networking solutions, and enterprise software.";
    } else if (userMessage.toLowerCase().includes('support')) {
      botResponse = "Our technical support team is available 24/7. You can also check our knowledge base for quick answers.";
      ...
      botResponse = "I'd be happy to arrange a product demo for you. Would you like to speak with an operator to schedule one?";
    } else {
      botResponse = "Thank you for your message. Would you like to speak with an operator?";
    }
    ...
    <div className="chatWidget">
      ...
      <div className={`chatContainer ${isOpen ? 'open' : ''}`}>
        <div className="chatHeader">
          <h3>Admin</h3>
          <button className="closeButton" onClick={toggleChat}>×</button>
        </div>
