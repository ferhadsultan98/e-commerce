...
const TechLogoSlider = () => {
  ...
  const techLogos = [
    { id: 1, name: 'TechCorp', imgSrc: 'https://www.techcorpholding.com/Logo5b.jpg', color: '#3498db' },
    { id: 2, name: 'InnovateTech', imgSrc: 'https://merojob.com/media/uploads/job_logo/4fa2acfe-211b-4396-8bb7-c1c86b8e1d5e.jpg', color: '#e74c3c' },
    ...
    { id: 5, name: 'TechWizards', imgSrc: 'https://scontent.fgyd6-1.fna.fbcdn.net/v/t39.30808-6/299584550_562357032255807_3343331028001858647_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=6ee11a&_nc_ohc=62_Zp9p76DsQ7kNvwGkfTPN&_nc_oc=AdkNTb-UImfOIoAH6CIPo1inhJESbyM0hE7rI5QRbMI0LH_bm6Y1amitKUuEQIRBLQw&_nc_zt=23&_nc_ht=scontent.fgyd6-1.fna&_nc_gid=48ALSxlblP1Qumr2rTRtFQ&oh=00_AfE-503c9u46_EUZhYbRU1DXxiPLCGFTMjzQiuSXMlOVQw&oe=68096FDB', color: '#9b59b6' },
