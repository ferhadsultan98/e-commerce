...
const TechLogoSlider = () => {
  ...
  // Sample tech company logos - replace with your actual logos
  const techLogos = [
  ...
  const visibleLogos = 4; // Number of logos visible at once (will adjust based on screen size)
  ...
  const prevSlide = () => {
    setCurrentIndex((prevIndex) => 
      prevIndex === 0 ? totalLogos - visibleLogos : prevIndex - 1
    );
  };
  ...
  return (
    ...
    >
      ...
      <div className="techLogoSlider__container">
        <button 
          className="techLogoSlider__navButton techLogoSlider__navButton--prev" 
          onClick={prevSlide}
        >
          &lt;
        </button>
        ...
        <button 
          className="techLogoSlider__navButton techLogoSlider__navButton--next" 
          onClick={nextSlide}
        >
          &gt;
        </button>
