...
import { ShoppingCart, Heart, Info, Trash2, AlertCircle } from "lucide-react";
import { Link } from "react-router-dom";
import "../../Styles/WishList.scss";
import RelatedProducts from "./RelatedProducts";

const WishList = ({ wishlistItems, onRemoveFromWishlist, onAddToCart, allProducts }) => {
  return (
    <div className="wishlist">
      ...
      {wishlistItems.length === 0 ? (
        ...
        <div className="wishlist__content">
          ...
          {wishlistItems.length > 0 && (
            <RelatedProducts product={wishlistItems[0]} allProducts={allProducts} />
          )}
        </div>
      )}
    </div>
...
const ShoppingCard = ({ cartItems, onRemoveFromCart, allProducts }) => {
    ...
    <div className="shopping-cart">
      ...
      {cartItems.length === 0 ? (
        ...
        <div className="shopping-cart__content">
          ...
          {cartItems.length > 0 && (
            <RelatedProducts product={cartItems[0]} allProducts={allProducts} />
          )}
        </div>
      )}
    </div>
