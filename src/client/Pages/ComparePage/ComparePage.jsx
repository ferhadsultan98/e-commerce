...
const ComparePage = ({ compareItems, onRemoveFromCompare }) => {
  ...
  const filteredCompareItems = compareItems.filter(
    ...
    <div className="comparePage">
      <div className="compareHeader">
        <h1>
          ...
          Müqayisə: {compareItems.length} məhsul
        </h1>
            ...
            <tbody>
              ...
              {filteredSpecs.map((spec, index) => {
                if (spec.type === "header") {
                  return (
                    <tr key={index} className="headerRow">
                      <td
                        className="featureCell headerCell"
                        colSpan={filteredCompareItems.length + 1}
                      >
                        {spec.label}
                      </td>
                    </tr>
                ...
                return (
                  <tr
                    key={index}
                    className={`specRow ${!allSame ? "differentRow" : ""}`}
                  >
